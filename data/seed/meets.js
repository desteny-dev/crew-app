...
export const seedMeets = [
  ...
  },
  {
    ...
    title: t('Konzert Kammgarn'), icon: '🎵', iconKey: 'note', category: 'event',
  ...
  // Runde 8 (R8-6): Ein Meet mit einer gemischten Runde (Lena und Tobi, keine gemeinsame Gruppe)
  // von vorgestern. Sein Chat ist seit Mitternacht danach VERGANGEN: Er steht nicht mehr in der
  // Chatliste, sondern unter „Vergangene Chats" — bis er sieben Tage nach dem Meet gelöscht wird.
  // Ohne dieses Beispiel wäre dieser Teil der Demo nie zu sehen.
  {
    id: MEETS.PIZZA_ALT,
    title: t('Pizzaabend bei Lena'), icon: '🍕', iconKey: 'pizza', category: 'essen',
    date: dayOffset(-2), time: '19:00', endTime: '22:30',
    place: { name: t('Bei {name}', { name: 'Lena' }), address: '' },
    personIds: [PEOPLE.LENA, PEOPLE.TOBI], creatorId: PEOPLE.LENA, status: 'done',
    participation: { [ME]: 'yes', [PEOPLE.LENA]: 'yes', [PEOPLE.TOBI]: 'yes' },
    variants: [], bring: [], polls: [],
  },
];
