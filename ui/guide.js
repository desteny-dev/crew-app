...
import { pushEinschalten, pushLage, pushGewuenscht } from './mitteilungen.js';
...
export function erlaubnisFragbar(art, ctx) {
  ...
  // Runde 11 (A5): 'vorgemerkt' = gewünscht, noch nie gefragt — genau der Fall zum Fragen. Wer den
  // Schalter selbst ausgeschaltet hat, wird auch hier nicht gefragt.
  return ['bereit', 'vorgemerkt'].includes(pushLage(ctx?.repo)) && pushGewuenscht();
}
...
const SCHRITTE = [
  {
    ...
    zeigen: {
      ...
      satz: () => tx('Deine Freunde sehen ab jetzt, dass du Zeit hast. Wer auch frei ist, hat einen grünen Punkt am Bild. Die Zahl links neben FREE zeigt, wie viele es sind.'),
    },
  },
  {
    id: 'karte',
