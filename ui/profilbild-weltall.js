...
// Runde 8: auch die Figuren (profilbild-figuren.js) werfen ihren Schatten damit.
export function schatten(cx, cy, r, { staerke = 0.17, versatz = 0.3, weite = 1.08 } = {}) {
...
// Runde 8 (R8-13): Der Astronaut ist in die Kategorie Figuren umgezogen (profilbild-figuren.js).
